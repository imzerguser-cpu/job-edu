...
export interface Account {id:string;schoolId:string;ownerType:'student'|'school';ownerId:string;balanceMinor:number;version:number;lastJournalId:string|null;status:'active';schemaVersion:1}
...
export interface AccountEntry {id:string;schoolId:string;journalId:string;type:'SALARY';deltaMinor:number;balanceAfterMinor:number;label:string}
