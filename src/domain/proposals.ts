export type ProposalType='job'|'business';
export type ProposalStatus='submitted'|'voting'|'closed'|'approved'|'rejected';
...
export interface Proposal {
  ...
  fields:JobProposalFields|BusinessProposalFields;
...
export const proposalTypeNames:Record<ProposalType,string>={job:'새 직업 제안',business:'새 사업 제안'};
export const proposalStatusNames:Record<ProposalStatus,string>={submitted:'검토 대기',voting:'투표 중',closed:'집계 완료',approved:'승인',rejected:'반려'};
