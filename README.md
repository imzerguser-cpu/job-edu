...
금융은 월급 정산·즉시 구매·저축(가입·만기 정산)·대출(신청·검토·승인·전액 상환)까지 구현되어 있습니다. 세금·과태료는 아직 없습니다(`docs/DECISIONS.md` D-17~D-21, D-48~D-55). 대출 상환은 전액 일시상환만 지원하며 분할·중도상환은 다음 단계입니다. 저축 만기 전 정산을 막는 것은 화면(교사가 만기 도래분만 미리보기에서 봄)뿐이며 Rules 레벨 강제는 없습니다. 대출 검토자는 교사가 활동 중인 학생 아무나 지정할 수 있으며 "은행원" 직업 보유를 강제하지 않습니다.
